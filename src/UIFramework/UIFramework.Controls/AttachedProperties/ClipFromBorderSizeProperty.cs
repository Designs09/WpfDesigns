...
namespace UIFramework.Controls
{
    ...
    /// The clipping region matches the border
    /// </summary>
    public class ClipFromBorderSizeProperty : BaseAttachedProperty<ClipFromBorderSizeProperty, bool>
    {
        /// <summary>
        ...
        private void Border_OnChanged(object sender, RoutedEventArgs e, FrameworkElement child)
        {
            ...
            // Set ractangle size to match child's excepted size
            rect.Rect = new Rect(0, 0, border.RenderSize.Width - border.BorderThickness.Left - border.BorderThickness.Right, border.RenderSize.Height - border.BorderThickness.Top - border.BorderThickness.Bottom);

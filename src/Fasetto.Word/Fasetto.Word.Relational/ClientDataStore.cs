...
namespace Fasetto.Word.Relational
{
    ...
    public class ClientDataStore : IClientDataStore
    {
        ...
        /// </summary>
        public async Task<bool> HasCredentialsAsync() => await GetLoginCredentialsAsync() != null;
        ...
        {
            // Get the first row in the login credentials talbe, or null if none exist
            return mDbContext.LoginCredentials.FirstOrDefaultAsync();
        }
